  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 md:space-y-8 animate-in fade-in duration-1000 pb-20 px-4 sm:px-0 text-slate-900 dark:text-white selection:bg-cyan-500/30">
      ...
      <div className="bg-white dark:bg-[#0a0a0a] border border-slate-200 dark:border-white/10 rounded-[2.5rem] md:rounded-[3rem] shadow-xl dark:shadow-2xl overflow-hidden relative group hover:border-slate-300 dark:hover:border-white/20 transition-all duration-500">
        <div className="bg-slate-50 dark:bg-white/5 p-8 md:p-10 border-b border-slate-200 dark:border-white/5 relative overflow-hidden">
           ...
           <h2 className="text-3xl md:text-4xl font-black tracking-tighter text-slate-900 dark:text-white relative z-10 uppercase">New Transaction<span className="text-cyan-400">.</span></h2>
        ...
        {success ? (
          <div className="p-16 md:p-24 flex flex-col items-center justify-center text-center space-y-6">
             ...
             <div className="space-y-2">
               <h3 className="text-xl md:text-2xl font-black text-slate-900 dark:text-white tracking-tight uppercase">Success!</h3>
              ...
              <button
                ...
                className={`py-3 md:py-4 rounded-xl md:rounded-2xl border-2 flex items-center justify-center gap-2 md:gap-3 text-[10px] md:text-xs font-black uppercase tracking-widest transition-all ${
                  formData.type === 'Expense' 
                    ? 'border-violet-500 bg-violet-500/10 text-violet-600 dark:text-violet-400 shadow-sm dark:shadow-[0_0_20px_rgba(139,92,246,0.15)]' 
                    : 'border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-white/5 text-slate-500 hover:border-slate-200 dark:hover:border-white/10 dark:hover:text-slate-300 shadow-sm'
                }`}
              >
                  ...
                  <div className="relative group/input">
                    ...
                    >
                      ...
                      {(formData.type === 'Income' ? categories.Income : categories.Expense).map(cat => (
                        <option key={cat} value={cat} className="bg-white dark:bg-[#0a0a0a]">{cat.toUpperCase()}</option>
                      ))}
                    </select>
                  </div>
                </div>
                ...
                <div className="space-y-2 md:space-y-3">
                  ...
                  <div className="relative group/input">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl md:rounded-2xl py-3 md:py-4 pl-12 md:pl-14 pr-4 focus:ring-1 focus:ring-cyan-500/50 outline-none transition-all font-bold text-[10px] md:text-xs text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-700 tracking-wider shadow-sm"
