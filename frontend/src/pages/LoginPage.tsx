...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="bg-white/60 backdrop-blur-2xl border border-white/50 rounded-[2.5rem] shadow-2xl shadow-rose-100/50 p-10 w-full max-w-md relative z-10">
        ...
        {error && (
          <div className="bg-rose-50 border border-rose-100 text-rose-600 p-4 rounded-2xl mb-8 text-sm font-medium animate-shake">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="block text-slate-600 text-sm font-bold ml-1">Username</label>
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-white/50 border border-slate-200 text-slate-800 rounded-2xl py-3.5 pl-11 pr-4 focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-transparent focus:bg-white transition-all shadow-sm"
          ...
          <div className="space-y-2">
            <label className="block text-slate-600 text-sm font-bold ml-1">Password</label>
            <div className="relative group">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-rose-500 transition-colors">
                <Lock size={18} />
              </span>
        ...
        <div className="mt-10 pt-8 border-t border-slate-100">
          <p className="text-center text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Demo Accounts</p>
          <div className="grid grid-cols-1 gap-2">
            <div className="flex justify-between items-center bg-slate-50 border border-slate-100 px-4 py-2.5 rounded-xl text-xs">
              <span className="font-bold text-slate-600">Admin</span>
              <span className="text-slate-400">admin / admin123</span>
            </div>
            <div className="flex justify-between items-center bg-slate-50 border border-slate-100 px-4 py-2.5 rounded-xl text-xs">
              <span className="font-bold text-slate-600">VIP</span>
              <span className="text-slate-400">vip_user / vip123</span>
            </div>
            <div className="flex justify-between items-center bg-slate-50 border border-slate-100 px-4 py-2.5 rounded-xl text-xs">
              <span className="font-bold text-slate-600">Free</span>
              <span className="text-slate-400">free_user / free123</span>
            </div>
          </div>
        </div>
      </div>
