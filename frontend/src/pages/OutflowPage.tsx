      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium">History of all outgoing money</p>
          </div>
        </div>
              ...
              {filteredTransactions.length > 0 ? filteredTransactions.map((t) => (
                <tr key={t.id} className="group hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-all">
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-rose-50 dark:bg-rose-500/10 text-rose-600 rounded-xl flex items-center justify-center font-bold">
                        {t.category.charAt(0)}
                      </div>
                  ...
                  <td className="px-8 py-6 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <span className="font-black text-rose-600">{formatCurrency(t.amount)}</span>
                    </div>
                  </td>
                </tr>
              )) : (
                <tr>
                  <td colSpan={4} className="px-8 py-20 text-center">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <p className="text-slate-400 font-medium italic">No outflow transactions found.</p>
                    </div>
                  </td>
                </tr>
              )}
